...
export function CartReviewModal({ open, onClose, store }: CartReviewModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-30 flex items-end justify-center bg-black/40 px-4 pb-6 pt-12 sm:items-center">
      <div className="w-full max-w-xl rounded-3xl bg-background shadow-lg">
